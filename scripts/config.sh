...
source /opt/scripts/supertransfer2/spinner.sh
...
[[ ! -e $userSettings ]] && cp /opt/scripts/supertransfer2/usersettings_template_dont_edit ${userSettings}
[[ ! -e ${jsonPath}/auto-rename-my-keys.sh ]] && cp /opt/scripts/supertransfer2/auto-rename-my-keys.sh $jsonPath
